...
/**
 * DataManager interface defines the contract for loading and saving data
 * related to Applicants, Applications, and Officers.
 * 
 * Any class implementing this interface must provide functionality for reading
 * from and writing to a data source (e.g., CSV files).
 * 
 * @author Hashir
 * @version 1.0
 */
