 ...
 * 
 * It provides a console-based menu interface for three types of users:
 * Admin, Officer, and Applicant.
 * 
 * The class allows users to interact with the system by performing
 * operations such as managing officers, processing applications,
 * and creating visa requests.
 * 
 * @author Ayham
 * @version 1.0
 */
public class Tester {
    ...
    public static void loadData(VisaOfficeSystem system) {
        ...
        system.addApplication(new StudentVisa(1004, a4, Status.PENDING, LocalDate.of(2026, 3, 15),
                null, "QU", 2, true));
    }
        ...
        do {
            ...
            if (choice == 1) {
                ...
                if (officer != null && app != null) {
                    ...
                    System.out.println("Application " + appNo + " has been assigned to officer " + officer + " successfully");
                } else {
        ...
        do {
            ...
            if (choice == 1) {
                ...
                if (app == null) {
                    ...
                    System.out.println("Application " + appNo
                            + " is already been processed. It cannot be removed/withdrawn");
                }
            }
    ...
    public static void createVisaApplication(VisaOfficeSystem system, Scanner in, Applicant applicant) {
        ...
        if (type == 1) {
            ...
            app = new StudentVisa(0, applicant, Status.PENDING, LocalDate.now(), null,
                    university, years, scholarship);
        }
            ...
            app = new WorkVisa(0, LocalDate.now(), applicant, Status.PENDING, null,
                    company, salary, years);
        }
    ...
    public static void printApplications(VisaOfficeSystem system, Status status, LocalDate beforeDate, Object owner) {
        System.out.printf("%15s %18s %15s %20s %12s %16s %15s %15s%n",
    ...
    public static void printApplicationRow(Application a) {
        ...
        System.out.printf("%15d %18s %15s %20s %12s %16s %15s %15s%n",
                a.getApplicationNO(),
                a.getApplicant().getName(),
                a.getApplicant().getPassportNo(),
                a.getApplicant().getNationality(),
                a.getStatus(),
                a.getSubmissionDate(),
                visaType,
                officerName);
    ...
    public static void printApplicationDetails(Application app) {
        ...
        System.out.println("Applicant Info: " + app.getApplicant().getName() + ", "
                + app.getApplicant().getPassportNo() + ", "
                + app.getApplicant().getNationality() + ", "
                + app.getApplicant().getBirthdate());
